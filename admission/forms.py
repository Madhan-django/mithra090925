...
class add_studentsForm(forms.ModelForm):
    class Meta:
        ...
        widgets ={
            ...
            'gender':forms.Select(choices=gender,attrs={'class': 'form-control','style': 'height: 50px;'}),
            'phone': forms.TextInput(attrs={'class':'form-control','placeholder': ' Moble/Phone No'}),
...
class trans_students(forms.ModelForm):
    class Meta:
        ...
        widgets ={
            ...
            'mother_occupation':forms.TextInput(attrs={'class':'form-control'}),
             'roll_no': forms.TextInput(attrs={'class':'form-control'}),
             'class_name': forms.Select(attrs={'class':'form-control','style':'height : 50px;'}),
             'secs':forms.Select(attrs={'class': 'form-control','style': 'height: 50px;'}),
             'ac_year':forms.Select(attrs={'class': 'form-control','style': 'height: 50px;'}),
             'school_student':forms.Select(attrs={'class':'form-control'}),
             'student_status':forms.Select(choices=stud_status,attrs={'class':'form-control','style':'height : 50px;'}),
