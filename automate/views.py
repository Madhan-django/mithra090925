...
def add_automate_task(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            auto_task.school = sdata
            auto_task.created_by = usr
            auto_task.save()
            ...
            if temp == "DAILY":
                ...
                run_dt = datetime.combine(run_date, run_time.time())
            else:
            ...
            if timezone.is_naive(run_dt):
                run_dt = timezone.make_aware(run_dt)
    ...
    return render(request, 'automate/add_task.html', {'form': form})
